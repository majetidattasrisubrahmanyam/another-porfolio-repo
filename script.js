...
${this.wrapWithColor(
  "   Developing computer vision systems, embedding audio pipelines,",
  "#ffffff"
)}
${this.wrapWithColor("   and deploying ML classifiers (TensorFlow/OpenCV)", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Bridging the gap between hardware (Arduino/IoT) and",
  "#ffffff"
)}
${this.wrapWithColor(
  "   software (full-stack web and backend services)",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor(
  "   Published IEEE researcher in real-time object tracking",
  "#ffffff"
)}
${this.wrapWithColor("   and ingredient logistics systems", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Excited to innovate and build the future of tech!     ",
      "#ffffff"
...
<span style="color: #00ffff;">LG SOFT INDIA | Research Engineer Intern</span>
${this.wrapWithColor(
  "Jul 2025 - Feb 2026 | Bengaluru, India",
  "#ffffff"
)}
${this.wrapWithColor(
  "BSP Division, Audio Renderer Team for LG Smart TVs",
  "#98fb98"
)}

• ${this.wrapWithColor("Embedded Audio Systems", "#ffa07a")} - ${this.wrapWithColor(
      "Contributed to development and validation of embedded audio firmware.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Defect Resolution", "#ffa07a")} - ${this.wrapWithColor(
      "Resolved 10+ pipeline issues (HDMI audio-video sync, volume control, codec compatibility).",
      "#ffffff"
    )}
• ${this.wrapWithColor("Data Flow Analysis", "#ffa07a")} - ${this.wrapWithColor(
      "Identified 5 synchronization bottlenecks in embedded multimedia pipelines.",
      "#ffffff"
    )}
• ${this.wrapWithColor("AI Audio Optimization", "#ffa07a")} - ${this.wrapWithColor(
      "Validated Personalized Sound Wizard (AI adaptive audio optimization) across 3 Smart TV SKUs.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "C++, Python, Embedded Systems, Linux, Audio Codecs, Git, Jira",
      "#87cefa"
    )}

<span style="color: #00ffff;">RINEX ON ARTIFICIAL INTELLIGENCE | AI/ML Intern</span>
${this.wrapWithColor(
  "Summer 2024 | Online",
  "#ffffff"
)}

• ${this.wrapWithColor("AI/ML Concepts", "#ffa07a")} - ${this.wrapWithColor(
      "Studied core concepts and practical applications of machine learning algorithms.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Hands-on Projects", "#ffa07a")} - ${this.wrapWithColor(
      "Worked on basic regression, classification and clustering tasks.",
      "#ffffff"
    )}
...
${this.wrapWithColor("📊 Performance:", "#ff8c00")} ${this.wrapWithColor(
      "GPA: 8.48",
      "#ffffff"
    )}
...
${this.wrapWithColor("📚 Key Courses:", "#ff8c00")}  ${this.wrapWithColor(
      "Operating Systems, Data Structures, Algorithms, Artificial Intelligence, Machine Learning, Networking, Databases",
      "#87cefa"
    )}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Specialized foundation in Intelligent Systems & CS",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
...
${this.wrapWithColor("Frameworks & AI Tools:", "#00ffff")}
• ${this.wrapWithColor("TensorFlow", "#ffffff")}
• ${this.wrapWithColor("Scikit-learn", "#ffffff")}
• ${this.wrapWithColor("OpenCV", "#ffffff")}
• ${this.wrapWithColor("Pandas / NumPy", "#ffffff")}
• ${this.wrapWithColor("React.js / Node.js / Express", "#ffffff")}
• ${this.wrapWithColor("Flask", "#ffffff")}
• ${this.wrapWithColor("Flutter", "#ffffff")}

${this.wrapWithColor("Tools & Platforms:", "#00ffff")}
• ${this.wrapWithColor("Git / GitHub", "#ffffff")}
• ${this.wrapWithColor("Docker", "#ffffff")}
• ${this.wrapWithColor("Linux", "#ffffff")}
• ${this.wrapWithColor("Jira", "#ffffff")}
• ${this.wrapWithColor("Arduino IDE / IoT Hardware", "#ffffff")}

${this.wrapWithColor("Soft Skills:", "#00ffff")}
• ${this.wrapWithColor("Communication & Teamwork", "#ffffff")}
• ${this.wrapWithColor("Problem-Solving & Adaptability", "#ffffff")}
• ${this.wrapWithColor("Time Management & Quick Learning", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:subrahmanyammajeti94@gmail.com" style="color: #ffffff; text-decoration: none;">subrahmanyammajeti94@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/majetidattasrisubrahmanyam" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/majetidattasrisubrahmanyam</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/subrahmanyam-majeti" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/subrahmanyam-majeti</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "AI Cooking Assistant & Recipe Scaler",
        description: "NLP-based platform for per-serving ingredient scaling and chatbot cooking assistance.",
        image: "image/recipe_platform.png",
        technologies: ["React", "Node.js", "Express", "PostgreSQL"],
        demo: "https://github.com/majetidattasrisubrahmanyam",
        repo: "https://github.com/majetidattasrisubrahmanyam",
      },
      {
        title: "Real-Time Vehicle Speed Estimation",
        description: "Real-time object tracking and speed analytics using YOLOv11 and SORT.",
        image: "image/vehicle_speed.png",
        technologies: ["Python", "YOLOv11", "OpenCV", "Kalman Filter"],
        demo: "https://github.com/majetidattasrisubrahmanyam",
        repo: "https://github.com/majetidattasrisubrahmanyam",
      },
      {
        title: "Brain Tumor Detection",
        description: "MRI classifier using fine-tuned VGG19 transfer learning, outperforming baseline by 9%.",
        image: "image/tumor_detection.png",
        technologies: ["Python", "TensorFlow", "OpenCV", "Pandas"],
        demo: "https://github.com/majetidattasrisubrahmanyam",
        repo: "https://github.com/majetidattasrisubrahmanyam",
      },
      {
        title: "Smart Classroom Lighting System",
        description: "IoT occupancy counter using PIR sensors and Arduino Uno, saving 30-40% power.",
        image: "image/smart_lighting.png",
        technologies: ["C++", "Arduino IDE", "IoT Hardware", "Python"],
        demo: "https://github.com/majetidattasrisubrahmanyam",
        repo: "https://github.com/majetidattasrisubrahmanyam",
      }
    ];
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "subra@majeti: ~/interactive-resume";
...
╚══════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝`;
    ...
    role.textContent = "Software Engineer & AI/ML Specialist";
    ...
    url.textContent = "majetidattasrisubrahmanyam.github.io";
